...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/chronic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11308&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/chronic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `chronic` can be installed with:

```
conda install chronic
```

It is possible to list all of the versions of `chronic` available on your platform with:
